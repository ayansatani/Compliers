...
infinity_long getFileSize(String fname);
...
************************************************************
*/
void startReader(String program, String input, Char mode, int size, int increment) {
...
/*
************************************************************
 * Tests for float-digit character string
 * Params:
